/// <mls fileReference="_102049_/l1/petShop/layer_1_external/adapters/http/dto/createProduct.ts" enhancement="_blank"/>

// Boundary DTO for the createProduct routine — the wire shape owned by the HTTP adapter. Alias of the
...
import type { CreateProductOutput } from '/_102049_/l1/petShop/layer_2_application/usecases/createProduct.js';
