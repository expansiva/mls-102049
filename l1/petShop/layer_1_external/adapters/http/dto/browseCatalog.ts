/// <mls fileReference="_102049_/l1/petShop/layer_1_external/adapters/http/dto/browseCatalog.ts" enhancement="_blank"/>

// Boundary DTO for the browseCatalog routine — the wire shape owned by the HTTP adapter. Alias of the
...
import type { BrowseCatalogOutput } from '/_102049_/l1/petShop/layer_2_application/usecases/browseCatalog.js';
